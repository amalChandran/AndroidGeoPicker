...
import com.novsys.helper.AppSettings;
import com.novsys.helper.IActionListener;
import com.novsys.helper.IFileSender;
import com.novsys.helper.Session;
import com.novsys.helper.Utilities;
...
public class MainActivity extends    Activity 
    ...
    private final ServiceConnection gpsServiceConnection = new ServiceConnection()
    {
        ...
        public void onServiceConnected(ComponentName name, IBinder service)
        {
            ...
            GpsLoggingService.SetServiceClient(MainActivity.this);


            Button buttonSinglePoint = (Button) findViewById(R.id.buttonSinglePoint);

            buttonSinglePoint.setOnClickListener(MainActivity.this);
            ...
            buttonOnOff.setOnCheckedChangeListener(MainActivity.this);
